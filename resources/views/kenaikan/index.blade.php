...
<div class="container mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-2xl px-6 py-4 min-w-[250px]">
...
<li>Menetapkan kelas tujuan bagi siswa yang memenuhi KKM.</li>

<li>Menetapkan status <strong>Lulus</strong> bagi siswa kelas VI.</li>

<li>Menyimpan data kenaikan kelas untuk proses <strong>Pembagian Kelas</strong>.</li>

<li>Pastikan seluruh nilai siswa telah final sebelum melanjutkan.</li>
