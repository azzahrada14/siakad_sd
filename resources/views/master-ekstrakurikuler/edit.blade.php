        ...
        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-6">
            ...
            <div>
                ...
                <h1 class="text-3xl font-bold text-slate-800">
                    ...
                    Edit Master Ekstrakurikuler

                </h1>

                <p class="text-gray-500 mt-1">

                    Perbarui data master ekstrakurikuler.
        ...
        <div class="bg-white rounded-xl shadow border border-gray-200">
            ...
            <div class="px-6 py-5 border-b bg-slate-50">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    ...
                    Perbarui data master ekstrakurikuler di bawah ini.
            ...
            <form
                action="{{ route('master-ekstrakurikuler.update',$masterEkstrakurikuler->id) }}"
                method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input
                                ...
                                value="{{ old('nama_ekstrakurikuler',$masterEkstrakurikuler->nama_ekstrakurikuler) }}"
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                name="pembina"
                                value="{{ old('pembina',$masterEkstrakurikuler->pembina) }}"
                                class="w-full rounded-lg border-gray-300">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                <option value="1"
                                    {{ old('wajib',$masterEkstrakurikuler->wajib)==1?'selected':'' }}>
                                    Ya
                                </option>

                                <option value="0"
                                    {{ old('wajib',$masterEkstrakurikuler->wajib)==0?'selected':'' }}>
                                    Tidak
                                </option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select
                                ...
                                <option value="Aktif"
                                    {{ old('status',$masterEkstrakurikuler->status)=='Aktif'?'selected':'' }}>
                                    Aktif
                                </option>

                                <option value="Nonaktif"
                                    {{ old('status',$masterEkstrakurikuler->status)=='Nonaktif'?'selected':'' }}>
                                    Nonaktif
                                </option>
