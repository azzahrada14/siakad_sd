...
<option
value="{{ $item->id }}"
{{ $jadwal->tahun_ajaran_id==$item->id ? 'selected' : '' }}>
...
<option
value="{{ $item->id }}"
{{ $jadwal->guru_id == $item->id ? 'selected' : '' }}>
...
<option
value="{{ $item->id }}"
{{ $jadwal->mapel_id == $item->id ? 'selected' : '' }}>
...
<option value="Senin" {{ $jadwal->hari=='Senin' ? 'selected' : '' }}>
Senin
</option>
...
<option value="Kamis" {{ $jadwal->hari=='Kamis' ? 'selected' : '' }}>
Kamis
</option>

<option value="Jumat" {{ $jadwal->hari=='Jumat' ? 'selected' : '' }}>
Jumat
</option>
