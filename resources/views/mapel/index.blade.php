...
@if(!$modeArsip)
    ...
    <div class="flex flex-wrap gap-3">
        ...
        {{-- TAMBAH MAPEL TAHUN AJARAN --}}
        <button
            type="button"
            onclick="cekMasterMapel()"
            class="inline-flex items-center gap-2 px-5 py-3
        ...
        {{-- TAMBAH MASTER MAPEL --}}
        <a
            href="{{ route('mapel.master.create') }}"
            class="inline-flex items-center gap-2 px-5 py-3
...
<div
    ...
    <div
        ...
        <div class="px-6 py-5 border-b">
            ...
            <p class="text-sm text-gray-500 mt-1">
                Sistem memeriksa Master Mata Pelajaran terlebih dahulu.
            </p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-green-800">
                                Master Mata Pelajaran tersedia.
                            </p>
                            ...
                            <p class="text-sm text-green-700 mt-1">
                                Silakan lanjut untuk memilih mata pelajaran
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-yellow-800">
                                Master Mata Pelajaran belum tersedia.
                            </p>

                            <p class="text-sm text-yellow-700 mt-1">
                                Tambahkan Master Mata Pelajaran terlebih
                                dahulu sebelum menambahkan mata pelajaran
                                pada tahun ajaran aktif.
                            </p>
...
function cekMasterMapel()
{
    const modal =
        document.getElementById('modalMasterMapel');
...
function tutupModalMasterMapel()
{
    const modal =
        document.getElementById('modalMasterMapel');
...
document
    .getElementById('modalMasterMapel')
